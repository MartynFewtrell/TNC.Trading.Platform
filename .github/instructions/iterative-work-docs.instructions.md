...
- Expected artifacts: a new `./docs/00x-work/` folder containing `requirements.md`, `technical-specification.md`, and `delivery-plan.md`.
- Validate success by confirming the `./docs/00x-work/` folder exists, is correctly numbered/named, and contains the required documents.
