...
These instructions standardize technology choices and contribution patterns across the repository.
They are intended for any change that touches product code, tests, documentation, infrastructure, or build configuration.
