...
In short: prefer instructions, agents, and skills for new reusable behavior; when you intentionally need the prompt-driven path, bootstrap the package, research the package, define and plan the work, then execute, review, and harden it.
