...
public sealed class AccountPreferencesHandlerTests
{
    ...
    private sealed class FakeCurrentStateStore(AccountPreferencesCurrentState? result) : IAccountPreferencesCurrentStateStore
    {
        ...
        public Task<AccountPreferencesDesiredStateCommitResult> FinalizeConfirmedSaveAsync(AccountPreferencesOperation operation, AccountPreferencesDesiredStateChange change, TrailingStopsPreferenceObservation observation, CancellationToken cancellationToken) => throw new NotSupportedException();
        public Task<AccountPreferencesReconciliationCompletion> CompleteObservedReconciliationAsync(Guid stateId, long desiredRevision, AccountPreferencesCurrentState state, TrailingStopsPreferenceObservation observation, CancellationToken cancellationToken) => throw new NotSupportedException();
