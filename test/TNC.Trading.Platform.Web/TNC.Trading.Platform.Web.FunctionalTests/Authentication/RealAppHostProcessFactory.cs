...
internal static class RealAppHostProcessFactory
{
    ...
    public static AppHostProcessHandle StartAppHostProcess()
    {
        ...
        var process = Process.Start(startInfo)
            ?? throw new InvalidOperationException("Failed to start the AppHost process for the functional authentication tests.");
    ...
    private static string GetRepositoryRoot()
    {
        ...
        throw new InvalidOperationException("Could not locate the repository root for the functional authentication tests.");
    }
}
